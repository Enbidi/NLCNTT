...
<template>
  <CommonActions :api-url="`${hostname}/admin/bill`" :deletion-modal="deletionModal" :updation-modal="updationModal" :fetched-data="billsStore" title="Hóa đơn" title-description="Thông tin các hóa đơn">
